...
<head>
  ...
  <link rel="stylesheet" href="articleView.css?v=<%=System.currentTimeMillis()%>">
  <script type="text/javascript" src="http://code.jquery.com/jquery-1.9.1.min.js"></script>
  <script type="text/javascript" defer src="articleRead.js?v=<%=System.currentTimeMillis()%>"></script>
</head>
				...
				<div class="articles__box">
					<div class="articles__id__form">
						<div class="articles__id" name="memberid" value=${articleread.memberid}>👤 ${articleread.memberid}</div>
	      				<form action="delete.do?no=${articleread.fileNo}" method="post">
