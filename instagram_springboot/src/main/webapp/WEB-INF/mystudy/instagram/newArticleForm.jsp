...
<meta charset="UTF-8">
<title>파일 업로드</title>
<script type="text/javascript" defer src="/css/upload.js?v=<%=System.currentTimeMillis()%>"></script>
<link rel="stylesheet" href="/css/upload.css">
</head>
<body>
  <section id="main__shape">
    <!-- multipart리퀘스트라는 클래스와 매칭이 되는 하나의 타입   이걸로 여러개의 파일이 폼태그로 전달이 될 수 있다.-->
      <form action="upload" method="post" enctype="multipart/form-data" frm.encoding = "application/x-www-form-urlencoded"  class="upload__shape">
        <div>
